    ...
    return (
      <div>
        ...
        <section class="py-12 px-4 text-center"><div class="w-full max-w-2xl mx-auto">
          <h2 class="mt-2 mb-6 leading-tight font-semibold font-heading text-4xl">Completed and Ongoing Projects</h2>
      ...
      <section class="py-12 px-4">
        <div class="flex flex-wrap items-center text-center lg:text-left -mx-2">
          ...
          <div class="lg:w-1/2 px-2 lg:pl-16 mt-10 lg:mt-0">
            <h2 class="text-5xl mb-6 leading-tight font-semibold font-heading">Bunnimage</h2>
      ...
      <section class="py-12 px-4">
        <div class="flex flex-wrap items-center text-center lg:text-left -mx-2">
          <div class="lg:w-1/2 px-2 lg:pr-10 mt-10 lg:mt-0 order-1 lg:order-none">
            <h2 class="text-5xl mb-6 leading-tight font-semibold font-heading">Serverless Bootcamp</h2>
      ...
      <section class="py-12 px-4">
        <div class="flex flex-wrap items-center text-center lg:text-left -mx-2">
          ...
          <div class="lg:w-1/2 px-2 lg:pl-16 mt-10 lg:mt-0">
            <h2 class="text-5xl mb-6 leading-tight font-semibold font-heading">VeryGoodForms</h2>
      ...
      <section class="py-12 px-4">
        <div class="flex flex-wrap items-center text-center lg:text-left -mx-2">
          <div class="lg:w-1/2 px-2 lg:pr-10 mt-10 lg:mt-0 order-1 lg:order-none">
            <h2 class="text-5xl mb-6 leading-tight font-semibold font-heading">AYA Survivorship</h2>
